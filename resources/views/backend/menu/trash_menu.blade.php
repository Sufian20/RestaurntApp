        ...
        <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-btn">
                        <a href="{{ url('re_store-menu') }}/{{ $men->id }}" class="btn btn-sm btn-info" style="margin: 5px;"><i class="far fa-edit"></i></a>
                        <a href="{{ url('parment-delete-menu') }}/{{ $men->id }}" class="btn btn-sm btn-danger" style="margin: 5px;"><i class="fas fa-trash-alt"></i></a>
