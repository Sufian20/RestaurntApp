        ...
        <div class="datatable-header">
            <div class="row align-items-center mb-3">
                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                    <a href="{{route('AllCategory')}}" class="btn btn-md btn-warning font-weight-semibold btn-py-2 px-4">View All Category</a>
                </div>
        ...
        <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
            ...
            <tbody>
             @foreach($categoris as $key => $cat)
                    ...
                    <td>{{$cat->deleted_at->format('d M Y')}}</td>
                    <td>
                    <a href="{{ url('restore-category') }}/{{ $cat->id }}" class="btn btn-sm btn-info">Restore</a>
                    <a href="{{ url('parment-delete-category') }}/{{ $cat->id }}" class="btn btn-sm btn-danger">Delete</a>
