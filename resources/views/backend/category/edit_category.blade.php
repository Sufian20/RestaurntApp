            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-2-5 col-xl-1-5">
                        ...
                        <p class="card-big-info-desc">Edit the menu categoris, which have in your restaured</p>
                    </div>
                        ...
                        <form role="form" action="{{route('UpdateCategory')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row align-items-center" style="margin-top:105px;">
                                ...
                                <div class="col-lg-7 col-xl-6">
                                    ...
                                    <input type="text" class="form-control form-control-modern" name="category_name" @error('category_name') is-invalid @enderror" value="{{ $categoris->category_name ?? old('category_name') }}" />
                                    @error('category_name')
                                ...
                                <br>
                                <button type="submit" class="mb-1 mt-1 mr-1 btn btn-success">Update</button>
